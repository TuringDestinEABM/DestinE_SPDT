...
@bp.route('/reportsDB/<scenario_name>', methods = ['GET'])
def specific_report_DB(scenario_name):
    scenario = getData.findDBData(scenario_name)
    return render_template("reportTemplateTEMP.html", scenario=scenario)
